...
def get(name, width=176, height=256, depth=1, n_filters=16, loss_function='binary_crossentropy', batch_norm=False):
  networks = dict(
    Unet=unet,
    UnetBN=unet_bn,
    ResUnet=resunet,
  ...
  return networks[name](width, height, depth, n_filters, loss_function, batch_norm)
